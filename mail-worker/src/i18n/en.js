const en = {
	...
	archiveMyAccount: 'Cannot archive your own email',
		accountTagLimit: 'Too many tags',
		accountTagLengthLimit: 'Tag length exceeds the limit',
		accountTagComma: 'Tags cannot contain commas',
