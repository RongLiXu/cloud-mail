const zh = {
    ...
    dbPassword: '密码',
    dbName: '数据库名',
    dbNameOptional: '数据库名（可空）',
    testConnection: '测试连接',
    exportSql: '导出 SQL',
    pushToExternal: '备份到外部',
    pullFromExternal: '从外部恢复',
    backupSchedule: '备份计划',
    ...
    backupSuccess: '备份完成',
    backupFailed: '备份失败',
    restoreConfirm: '将从外部数据库导入数据，可能覆盖已有数据，是否继续？',
    backupSaveConfig: '保存配置',
    backupRunning: '备份进行中...',
    d1Binding: 'D1 绑定名',
    d1BindingDesc: 'wrangler.toml 中的绑定名'
}
export default zh
