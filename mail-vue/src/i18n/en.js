const en = {
    ...
    dbNameOptional: 'Database Name (optional)',
    testConnection: 'Test Connection',
    exportSql: 'Export SQL',
    pushToExternal: 'Backup to External',
    pullFromExternal: 'Restore from External',
    backupSchedule: 'Backup Schedule',
    cronExpression: 'Cron Expression',
    backupDirection: 'Backup Direction',
    push: 'Push',
    pull: 'Pull',
    ...
    restoreConfirm: 'This will import data from the external database. Existing data may be overwritten. Continue?',
    backupSaveConfig: 'Save Config',
    backupRunning: 'Backup in progress...',
    d1Binding: 'D1 Binding Name',
    d1BindingDesc: 'The binding name in wrangler.toml'
}
